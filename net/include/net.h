...
int learning_discrete_BayNet(char * logical_factorgraph, char * learnt_factorgraph, char *obs_data,char *nodepost, int num_state, int max_num_repeat, double LLchangeLimit, int MAPflag, int logging);
