...
This tool is used for converting csv observation files dominant state tables.

=head1 NAME

CSV observation file converter to dominant state - PGMLab Bio

=head1 REQUIRED

=item --observation-file [=] <observation_file>

Input observation data filepath

=for Euclid:
   observation_file.type = readable
